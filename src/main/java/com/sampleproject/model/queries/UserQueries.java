...
public class UserQueries {
    public static final String saveUserQuery="INSERT INTO user" +
            "(userId, firstName, lastName, birthOfDate, username) VALUES (?,?,?,?,?)";
    public static final String saveUserProductQuery="INSERT INTO user_product(userId, productId) VALUES (?,?)";
    public static final String updateUserQuery="UPDATE user SET " +
            "firstName=?, lastName=?, birthOfDate=?, username=? WHERE userId=?";
